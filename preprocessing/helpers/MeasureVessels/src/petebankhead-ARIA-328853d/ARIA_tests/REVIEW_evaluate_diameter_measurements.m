...
%for ii = n_images:-1:1 % (Can go in descending order to avoid preallocation) % mattia: old for loop  
chunk_end = chunk_start+chunk_size-1; % mattia: adding logic to break down into chunks (rather than processing all images at once)
