...
main_phenotypes_seaborn = sys.argv[3] #["bifurcations", "VD_orig_all", "slope", "mean_angle_taa", "mean_angle_tva", "eq_CRAE", "eq_CRVE", "medianDiameter_all", "DF_all"]
plot_violin = sys.argv[4] #True
plot_histograms = sys.argv[5] # False
plot_seaborn = sys.argv[6] #True

old_names = sys.argv[7] #list of all names
new_names = sys.argv[8]
...
df_data_completo.rename(columns=dict(zip(old_names, new_names)), inplace=True)
...
if plot_violin==True:
    ...
    list_phenotypes = ["ratio_medianDiameter_longest", "ratio_CRAE_CRVE", "ratio_DF_longest"]
    my_pal= {"ratio_medianDiameter_longest": "g", "ratio_CRAE_CRVE": "b", "ratio_DF_longest": "m"}
    f_plot.violin_plot(df_data_completo, list_phenotypes, save_dir, my_pal)
