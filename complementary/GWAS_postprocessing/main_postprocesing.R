setwd("/HDD/data/UKBiob/GWAS/2022_06_08_all_phenotypes_LWNet_Decile3/")

pheno_list <- c("bifurcations", "median_CRAE", "eq_CRAE", "median_CRVE", "eq_CRVE", "ratio_median_CRAE_CRVE", "ratio_CRAE_CRVE",
                "medianDiameter_all", "DF_all", "slope", "slope_artery", "slope_vein",
...
source("/SSD/home/sofia/retina-phenotypes/complementary/GWAS_postprocessing/plotGWAS.R")
foo_plotGWAS(pheno_list)

#source("/SSD/home/sofia/retina-phenotypes/complementary/GWAS_postprocessing/hit_to_csv.R")
#foo_hit_to_csv(pheno_list)

#source("/SSD/home/sofia/retina-phenotypes/complementary/GWAS_postprocessing/prepare_input.R")
