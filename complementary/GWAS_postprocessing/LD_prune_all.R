...
setwd("/Users/sortinve/Desktop/Enseñanza/Biological_problems_that_req_maths/BMI_changes/23-03-2022_mini_BMIxy/")
# INSTRUCTIONS 
...
hits <- hits[order(hits$PI.log10p, decreasing=TRUE), ] # order by pvalue
...
write.csv(result, paste0("GWAS_results_pruned_R2_", r2_thresh,"_", hits_file, "_",pop,"_all.csv"), row.names = F)
end.time <- Sys.time()
